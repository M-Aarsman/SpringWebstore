...
<section class="container">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <label class="control-label col-lg-2 col-lg-2" for="manufacturer">Firma</label>
            <div class="col-lg-10">
            ...
            <label class="control-label col-lg-2 col-lg-2" for="unitsInOrder">Liczba sztuk w zamówieniu</label>
            <div class="col-lg-10">
